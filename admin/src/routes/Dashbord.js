...
import CreateGuide from "../containers/CreateGuideV2";
...
const Nav = () => {
  ...
  const [Content, setContent] = useState(<DashBoardContainer />);
  return (
    <div style={{ display: "flex" }}>
      <aside className="flex flex-col w-64 h-screen px-5 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
        <a href="/">
          <div style={{ color: "white", fontSize: "20px" }}>{JSON.parse(sessionStorage.getItem("adminInfo")).adminname}</div>
          ...
          <nav className="-mx-3 space-y-6 ">
            ...
            <div className="space-y-3 ">
              ...
              >
                ...
                <span className="mx-2 text-sm font-medium">Sponsorships</span>
              </button>
              <button
                className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
                onClick={() => {
              ...
              >
                ...
                <span className="mx-2 text-sm font-medium">Create Guide</span>
              </button>
            </div>
