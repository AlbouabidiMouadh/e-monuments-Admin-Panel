...
import CreateGuide from "../containers/CreateGuide";
...
const Nav = () => {
  const [Content, setContent] = useState(<CreateGuide />);
  return (
    <div style={{ display: "flex" }}>
      <aside class="flex flex-col w-64 h-screen px-5 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
        <a href="/">
          <div style={{ color: "white", fontSize: "20px" }}>Admin</div>
          ...
          <nav class="-mx-3 space-y-6 ">
            ...
            <div class="space-y-3 ">
              ...
              <button
                class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
                onClick={() => {
                  setContent(<SponsorshipsContainer />);
                }}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span class="mx-2 text-sm font-medium">Sponsorships</span>
              </button>
              <button
                class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
                onClick={() => {
                  setContent(<CreateGuide />);
                }}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span class="mx-2 text-sm font-medium">Create Guide</span>
              </button>
            </div>
            ...
            <div class="space-y-3 ">
              ...
              >
                ...
                <span class="mx-2 text-sm font-medium">Admins</span>
              </button>

              <button
                class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
                onClick={() => {
                  setContent(<UsersContainer />);
                }}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              >
                ...
                <span class="mx-2 text-sm font-medium">Create Admin</span>
              </button>
            </div>
          </nav>
        </div>
